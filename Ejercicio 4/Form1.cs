...
namespace Ejercicio_4
{
    public partial class Form1 : Form
    {
        ...
        //Funcion de como calcular el salario usando "IF"
        ...
        private void btnAgregarVenta_Click(object sender, EventArgs e) //Almacena las ventas
        {
            int ventasBrutas;
